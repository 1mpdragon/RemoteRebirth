package net.mcreator.rebirthinc;
...
@Mod("rebirth_inc")
public class RebirthIncMod {
	public static final Logger LOGGER = LogManager.getLogger(RebirthIncMod.class);
	public static final String MODID = "rebirth_inc";

	public RebirthIncMod() {
