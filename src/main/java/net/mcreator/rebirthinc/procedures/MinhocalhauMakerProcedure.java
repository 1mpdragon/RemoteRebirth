...
public class MinhocalhauMakerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (itemstack.getItem() == RebirthIncModItems.MINHOCA.get() && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.DIRT) {
			{
